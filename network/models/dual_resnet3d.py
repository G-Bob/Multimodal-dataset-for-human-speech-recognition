...
class dualresnet(nn.Module):
    def __init__(self,block2d,block3d,num_block,num_classes=15):
        ...
        self.fc = nn.Linear(7168, num_classes)  # Concatenated output size is 4096
    ...
    def forward(self, input1, input2):
        ...
        out2 = self.input3_net(input2)
        #out2 = self.conv6_3d(out2)
        # out2 = self.conv2_3d(out2)
        out2 = self.conv3_3d(out2)
        out2 = self.conv4_3d(out2)
        out2 = self.conv5_3d(out2)
...
def dualresnet3d():
    ...
    """
    return dualresnet(BasicBlock,BasicBlock3d, [2, 2, 2, 2])